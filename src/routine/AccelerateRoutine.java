 ...
 * {@link Instruction} to {@link Routine#Routine(String, List, List)}, even if
 * the best way to define a routine is by creating a .rou file that can be
...
public class AccelerateRoutine extends Routine {
	...
	public AccelerateRoutine() {
		super("Accelera 1000->2000 a 50 rpm/s", Arrays
				.asList(TelemetryParameter.values()),
