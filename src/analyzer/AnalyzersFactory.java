...
public class AnalyzersFactory {
	...
	public static Analyzer newInstanceOf(Class<? extends Analyzer> cls, File logFile, File propertyFile)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		return (Analyzer) cls.getConstructor(File.class, File.class).newInstance(logFile, propertyFile);
	}
}
