...
public class AnalyzersFactory {
	...
	/**Scans the classes through reflection to find all the subclasses of {@link Analyzer}
	...
	public static Analyzer newInstanceOf(Class<? extends Analyzer> analyzerSubclass, File dataFile, File propertyFile)
		...
		return (Analyzer) analyzerSubclass.getConstructor(File.class, File.class).newInstance(dataFile, propertyFile);
	}
}
